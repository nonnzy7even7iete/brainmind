    ...
    <section className="min-h-screen bg-[#0d0d0d] text-white flex flex-col justify-center items-center px-6 md:px-20 pt-20 md:pt-32 lg:pt-40">
      <div className="grid md:grid-cols-2 gap-12 items-center max-w-6xl w-full">
        ...
        <motion.div
          ...
          className="space-y-6"
        >
          <h1 className="text-4xl md:text-5xl font-bold relative z-50">
            Nonnzy{" "}
            <span>
              <GradientText
                text="Transformmium"
          ...
          <p className="text-gray-400 max-w-md relative z-50">
        ...
        >
          <div className="relative w-72 h-72 flex items-center justify-center pointer-events-none">
            ...
            <motion.div
              ...
              className="absolute w-full h-full rounded-full border-2 border-green-400 border-dashed"
            />
            {/* Contour acier + photo */}
            <div className="absolute w-64 h-64 rounded-full p-[2px] bg-gradient-to-tr from-gray-400 via-gray-200 to-gray-500 flex items-center justify-center">
          ...
          <motion.h2
            ...
            className="mt-4 text-center text-white relative z-50"
          >
            <GradientText
      ...
      {/* Stats synchronisés */}
      <div className="grid grid-cols-2 md:grid-cols-4 gap-8 mt-16 text-center relative z-50">
        <div>
